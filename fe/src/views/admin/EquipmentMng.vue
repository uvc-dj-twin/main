  ...
  >
    ...
    <div class="content-wrapper">
      <div class="container switch-control">
        ...
        <div>
          <label for="checked" style="padding: 10px 70px 10px 0"> 권한부여 </label>
          <SwitchComponent :v-model="row.그룹A" id="checked" :checked="row.그룹A"></SwitchComponent>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="content-wrapper">
      <div class="container switch-control">
        ...
        <div>
          <label for="checked" style="padding: 10px 70px 10px 0"> 권한부여 </label>
          <SwitchComponent :v-model="row.그룹B" id="checked" :checked="row.그룹B"></SwitchComponent>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="content-wrapper">
      <div class="container switch-control">
        ...
        <div>
          <label for="checked" style="padding: 10px 70px 10px 0">  권한부여 </label>
          <SwitchComponent :v-model="row.그룹C" id="checked" :checked="row.그룹C"></SwitchComponent>
        </div>
      </div>
    </div>
  </div>
...
// page(몇 페이지인지)
    ...
    console.log(pages.value)
      ...
      return {
    columnList,data,pages,handlePages
  }
